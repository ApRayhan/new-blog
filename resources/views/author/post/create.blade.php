                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="email_address" class="form-control" placeholder="Enter Post Title" name="title">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input id="publish" class="filled-in" type="checkbox" name="status" value="1">
