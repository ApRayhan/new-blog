...
@section('content')
	<a href="{{ route('author.post.create') }}" class="btn btn-primary waves-effect"><i class="material-icons">add</i><span>Add New Post</span></a><br><br>
    <!-- Exportable Table -->
                         ...
                         <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                             ...
                             <tbody>
                                 @foreach ($posts as $key=>$post)
                                     ...
                                     <td>
                                        <a class="btn btn-info btn-sm" href="{{ route('author.post.show', $post->id) }}"><i class="material-icons">visibility</i></a>
                                         <a href="{{ route('author.post.edit', $post->id) }}" class="btn btn-primary btn-sm"><i class="material-icons">create</i></a>
                                         <button onclick="deletePost({{ $post->id }})" type="button" class="btn btn-danger btn-sm"><i class="material-icons">delete_sweep</i></button>
                                         <form action="{{ route('author.post.destroy', $post->id ) }}" method="post" id="delete-form-{{ $post->id }}">
                                            @csrf
                                            @method('DELETE')
